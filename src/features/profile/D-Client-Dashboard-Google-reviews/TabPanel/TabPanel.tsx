...
//   // Фільтрація коментарів для прикладу
//   const repliedComments = comments.filter((c) =>
//     c.content.toLowerCase().includes("reply")
//   );
...
//   // Рендер коментарів за сторінкою
...
//               page={pageAll}
//               onPageChange={(_e, newPage) => setPageAll(newPage)}
...
//             <TablePagination
//               component="div"
//               count={repliedComments.length}
//               page={pageReplied}
//               onPageChange={(_e, newPage) => setPageReplied(newPage)}
//               rowsPerPage={ROWS_PER_PAGE}
//               rowsPerPageOptions={[]}
//               sx={{ mt: 2 }}
//             />
...
//               page={pageUnreplied}
//               onPageChange={(_e, newPage) => setPageUnreplied(newPage)}
//               rowsPerPage={ROWS_PER_PAGE}
//               rowsPerPageOptions={[]}
//               sx={{ mt: 2 }}
//             />
	...
	return (
		<div style={{display:"flex" ,justifyContent:"space-between" ,alignItems:'center'}}>
			<div className={style.timezone__button}>
				<p style={{color:"grey" , font:"400 14px Open Sans"}}>Showing 1-10 of 24 entries</p>
			</div>
			<div
				style={{
					display: "flex",
