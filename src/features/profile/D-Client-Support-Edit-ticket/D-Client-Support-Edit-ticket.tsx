import styles from "./D-Client-Support-Edit-ticket.module.scss";
import { Sidebar, ClientProfileTop, Button } from "../imports/components.ts";
...
export default function D_Client_Support_Edit_ticket() {
	...
	return (
		<div style={{ display: "flex", justifyContent: "center" }}>
			...
			<div className={styles.wrapper}>
				<section>
					<ClientProfileTop>Support - Tickets - Edit ticket</ClientProfileTop>
							...
							<div className={styles.create__item}>
								...
								<input
									...
									className={classnames(
										styles.create__input,
										styles.create__input_small,
									)}
